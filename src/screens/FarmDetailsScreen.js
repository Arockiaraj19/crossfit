...
const FarmDetailsScreen = ({ navigation, route }) => {
    ...
    const onPressSaveProfile = () => {
        ...
        //     }
        //     // console.log('updateUserProfile',{ Id: 0, gender: parseInt(userGender), dob: userBirthDate, emailId: userEmail, preferredLanguageId: parseInt(userLanguageId), primaryRoleId: parseInt(userRoleId)})
        //     updateUserProfile({
        //         variables: { Id: 0, gender: parseInt(userGender), dob: userBirthDate, emailId: userEmail, preferredLanguageId: parseInt(userLanguageId), primaryRoleId: parseInt(userRoleId)}
        //     })
        //         .then(res => {
